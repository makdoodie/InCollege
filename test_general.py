...
def test_signup2(system_instance, name_register, capsys): #test that a registered  user can login from the general signup option
...
def test_helpcenter(system_instance, temp_remove_accounts, capsys): 
  input = ['5', '1', '2', '0', '0', '0', '0']
  with mock.patch('builtins.input', side_effect=input):
    system_instance.home_page()
  captured = capsys.readouterr()
